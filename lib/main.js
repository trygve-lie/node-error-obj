...
Object.keys(defs).forEach((name) => {
    ...
    module.exports[fnName] = function () {
        if (!(this instanceof module.exports[fnName])) return new module.exports[fnName]();
        Error.captureStackTrace(this, module.exports[fnName]);
    ...
    module.exports[fnName].prototype.cause = function () {
        return this.parent;
    };
});
